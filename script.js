...
const gifSearchBtn = document.getElementById("searchGif");
const videoSearchBtn = document.getElementById("searchVideo");
let themeColor = document.querySelectorAll('.theme-toggler span');

// API key, paginations, searchTerm variables
const apiKey = "5nsNb0q3P97wYuxFR41qvGuPt84R1L3aMTYHLwoiKUKEfIZl9Gn3lqdK";
const perPage = 4;
let currentPage = 1;
let searchTerm = null;
